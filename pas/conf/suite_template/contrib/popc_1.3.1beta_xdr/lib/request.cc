...
// Set the uniqueId
void Request::setUniqueId(paroc_string uniqueId){
    _uniqueId = uniqueId;
}

// Get the uniqueId
paroc_string Request::getUniqueId(){
    return _uniqueId;
}
...
// Set the nodeId
void Request::setNodeId(paroc_string nodeId){
    _hasNodeIdSet = true;
    _nodeId = nodeId;
}

// Get the nodeId
paroc_string Request::getNodeId(){
    return _nodeId;
}
...
void Request::setOperatingSystem(paroc_string operatingSystem){
    _hasOperatingSystemSet = true;
    _operatingSystem = operatingSystem;
}

// Get operating system
paroc_string Request::getOperatingSystem(){
...
// set the protcol
void Request::setProtocol(paroc_string prot){
    _hasProtocolSet=true;
    _protocol=prot;
}

// get the protocol
paroc_string Request::getProtocol(){
    return _protocol;
}
...
// set the encoding
void Request::setEncoding(paroc_string enc){
    _hasEncodingSet=true;
    _encoding=enc;
}

// get the encoding
paroc_string Request::getEncoding(){
    return _encoding;
}
...
void Request::addNodeToExplorationList(paroc_string nodeId,
