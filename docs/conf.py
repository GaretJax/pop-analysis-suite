# -*- coding: utf-8 -*-
#
# PAS documentation build configuration file, created by
...
# Display todo items in the documentation
...
latex_documents = [
  ('index', 'PAS.tex', u'PAS Documentation',
